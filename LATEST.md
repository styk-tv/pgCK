<!--
  ...
  run will overwrite your changes. Last refresh: 2026-08-27 03:27:09Z (side: ext).
-->
...
## pgCK extension — `v0.4.86` (PostgreSQL 18)

`oras pull ghcr.io/styk-tv/pgck:0.4.86-pg18-<arch>` → drop `lib/pgck.so` + `share/extension/{pgck.control, pgck--0.4.86.sql}` next to your `postgres:18` install (glibc ≥ 2.38 base — trixie/noble).

| arch  | Pull URI                                  | Digest                                                                  | Created (UTC)       |
|-------|-------------------------------------------|-------------------------------------------------------------------------|---------------------|
| amd64 | `ghcr.io/styk-tv/pgck:0.4.86-pg18-amd64`   | `sha256:7f25a86ec101b41d7bf0f92ff25d11549469add9315ca4852b91e8782bde80a8` | 2026-08-27 03:25:53 |
| arm64 | `ghcr.io/styk-tv/pgck:0.4.86-pg18-arm64`   | `sha256:17c93a6e911f7e9de64e91534e41e25b111f4400ca2d15377dcb2689b36d69a8` | 2026-08-27 03:25:10 |

|                       |                                                                          |
|-----------------------|--------------------------------------------------------------------------|
| Artifact type         | `application/vnd.styk.pgck.extension.v1`                                 |
| Tarball mirror        | https://github.com/styk-tv/pgCK/releases/tag/v0.4.86                  |
...
| Provenance            | SLSA Build Provenance v1 — verify with `gh attestation verify oci://ghcr.io/styk-tv/pgck:0.4.86-pg18-amd64 --repo styk-tv/pgCK` |
