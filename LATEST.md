<!--
  ...
  run will overwrite your changes. Last refresh: 2026-09-01 11:06:36Z (side: ext).
-->
...
## pgCK extension — `v0.4.89` (PostgreSQL 18)

`oras pull ghcr.io/styk-tv/pgck:0.4.89-pg18-<arch>` → drop `lib/pgck.so` + `share/extension/{pgck.control, pgck--0.4.89.sql}` next to your `postgres:18` install (glibc ≥ 2.38 base — trixie/noble).

| arch  | Pull URI                                  | Digest                                                                  | Created (UTC)       |
|-------|-------------------------------------------|-------------------------------------------------------------------------|---------------------|
| amd64 | `ghcr.io/styk-tv/pgck:0.4.89-pg18-amd64`   | `sha256:ae70756ca8ff2f11ec3d613a85a273deaca182f1e1c05aed794bb138f1335fec` | 2026-09-01 11:05:50 |
| arm64 | `ghcr.io/styk-tv/pgck:0.4.89-pg18-arm64`   | `sha256:c68df23c9b1517d872c38ad6244d3fd831e0bc8a69aab470a1b8c0594c183011` | 2026-09-01 11:03:54 |

|                       |                                                                          |
|-----------------------|--------------------------------------------------------------------------|
| Artifact type         | `application/vnd.styk.pgck.extension.v1`                                 |
| Tarball mirror        | https://github.com/styk-tv/pgCK/releases/tag/v0.4.89                  |
...
| Provenance            | SLSA Build Provenance v1 — verify with `gh attestation verify oci://ghcr.io/styk-tv/pgck:0.4.89-pg18-amd64 --repo styk-tv/pgCK` |
