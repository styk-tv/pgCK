<!--
  ...
  run will overwrite your changes. Last refresh: 2026-08-28 22:27:06Z (side: ext).
-->
...
## pgCK extension — `v0.4.88` (PostgreSQL 18)

`oras pull ghcr.io/styk-tv/pgck:0.4.88-pg18-<arch>` → drop `lib/pgck.so` + `share/extension/{pgck.control, pgck--0.4.88.sql}` next to your `postgres:18` install (glibc ≥ 2.38 base — trixie/noble).

| arch  | Pull URI                                  | Digest                                                                  | Created (UTC)       |
|-------|-------------------------------------------|-------------------------------------------------------------------------|---------------------|
| amd64 | `ghcr.io/styk-tv/pgck:0.4.88-pg18-amd64`   | `sha256:b58b42188e279e5203efbfe291c46f32198c145b19c43fe4e61fe21e38958d3c` | 2026-08-28 22:25:44 |
| arm64 | `ghcr.io/styk-tv/pgck:0.4.88-pg18-arm64`   | `sha256:78810f67f4b0da6d730c5091eb364b2234738a23804ca19e76d4e9e9b920274e` | 2026-08-28 22:24:58 |

|                       |                                                                          |
|-----------------------|--------------------------------------------------------------------------|
| Artifact type         | `application/vnd.styk.pgck.extension.v1`                                 |
| Tarball mirror        | https://github.com/styk-tv/pgCK/releases/tag/v0.4.88                  |
...
| Provenance            | SLSA Build Provenance v1 — verify with `gh attestation verify oci://ghcr.io/styk-tv/pgck:0.4.88-pg18-amd64 --repo styk-tv/pgCK` |
